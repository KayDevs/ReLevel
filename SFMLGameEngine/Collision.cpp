...
sf::IntRect Collision::GetAABB(const sf::Sprite& Object) {
    ...
    sf::Vector2f pos = Object.getInverseTransform().transformPoint(sf::Vector2f(0, 0));
 
    //Store the size so we can calculate the other corners
    sf::Vector2f size = Object.getScale();
    ...
    AABB.left = static_cast<int> (pos.x);
	AABB.top = static_cast<int> (pos.y);
    return AABB;
}
...
bool Collision::PixelPerfectTest(const sf::Sprite& Object1, const sf::Sprite& Object2, sf::Uint8 AlphaLimit) {
    ...
    if (Object1AABB.intersects(Object2AABB, Intersection)) {
        ...
        sf::FloatRect O1SubRect = Object1.getGlobalBounds();
        sf::FloatRect O2SubRect = Object2.getGlobalBounds();
        ...
        for (int i = Intersection.left; i < Intersection.left+Intersection.width; i++) {
            for (int j = Intersection.top; j < Intersection.top+Intersection.height; j++) {
                ...
                o1v = Object1.getTransform().transformPoint(sf::Vector2f(i, j)); //Creating Objects each loop :(
                o2v = Object2.getTransform().transformPoint(sf::Vector2f(i, j));
                ...
                if (o1v.x > 0 && o1v.y > 0 && o2v.x > 0 && o2v.y > 0 &&
                    ...
                    //If both sprites have opaque pixels at the same point we've got a hit
							const sf::Texture *o1txt = Object1.getTexture();
							const sf::Image o1img = o1txt->copyToImage();
							const sf::Texture *o2txt = Object2.getTexture();
							const sf::Image o2img = o2txt->copyToImage();
							if ((o1img.getPixel(static_cast<int> (o1v.x), static_cast<int> (o1v.y)).a > AlphaLimit) &&
                            (o2img.getPixel(static_cast<int> (o2v.x), static_cast<int> (o2v.y)).a > AlphaLimit)) {
                        return true;
                    }
                }
            }
...
bool Collision::CircleTest(const sf::Sprite& Object1, const sf::Sprite& Object2) {
    ...
    float Radius1 = (Object1.getScale().x + Object1.getScale().y) / 4;
    float Radius2 = (Object2.getScale().x + Object2.getScale().y) / 4;
...
bool Collision::BoundingBoxTest(const sf::Sprite& Object1, const sf::Sprite& Object2) {
    ...
    sf::Vector2f HalfSize1 = Object1.getScale();
    sf::Vector2f HalfSize2 = Object2.getScale();
